...
export default function MatchDetails() {
    ...
    const clubsData = [
        { name: 'Jesselball Sport Center', location: 'Simpang Ampat, P. Pinang', logo: ClubLogo },
        { name: 'Jesselball Sport Center', location: 'Simpang Ampat, P. Pinang', logo: ClubLogo },
        { name: 'Jesselball Sport Center', location: 'Simpang Ampat, P. Pinang', logo: ClubLogo },
        { name: 'Jesselball Sport Center', location: 'Simpang Ampat, P. Pinang', logo: ClubLogo },
        { name: 'Jesselball Sport Center', location: 'Simpang Ampat, P. Pinang', logo: ClubLogo },
                            ...
                            <Col key={index} xs={3}>
                                <div>
                                    <Stack direction='vertical' gap={3} style={{ alignItems: 'center' }}>
                                        <img src={club.logo} alt="" width={250} height={180} style={{ borderRadius: '10px', border: '0.5px solid #DCDCDC' }} />
                                        <div>
                                            <p style={{ marginBottom: '0rem', marginTop: "0.1rem" }}>{club.name}</p>
                                            <p className='font-italic' style={{ color: "#a4a4a4" }}>{club.location}</p>
                                        </div>
                                    </Stack>
                                </div>
                            </Col>
